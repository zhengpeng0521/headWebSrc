...
//引入页面模板
import TeachersMainDesignComponent from '../../general_template/generalMainDesignComponent';
import TeachersPageComponent from './teachersDayPageDesignComponent';
...
let SummerCampDesignComponent = React.createClass({
	...
	render(){
		...
		return (
			<div>
				{
					currentPageType == '' ? < TeachersMainDesignComponent   mainData = { mainData }
					...
					: currentPageType == 'Page1Component' ? <TeachersPageComponent   detailData = { detailData }
