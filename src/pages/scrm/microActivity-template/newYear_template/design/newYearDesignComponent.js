...
//引入页面模板
let NewYearMainDesignComponent = require('../../general_template/generalMainDesignComponent');
let NewYearPage1DesignComponent = require('../../general_template/Page1DesignComponent1');
let NewYearPage2DesignComponent = require('../../general_template/Page2DesignComponent');
let NewYearPage3DesignComponent = require('../../general_template/Page4DesignComponent');
//公共组件
let NewYearPage4DesignComponent = require('../../general_template/Page5DesignComponent');
let NewYearPage5DesignComponent = require('../../general_template/Page6DesignComponent');


let NewYearDesignComponent = React.createClass({
	getInitialState() {
		return {
	...
	render(){
		...
		return (
			...
			<div>
				{
					currentPageType == '' ? < NewYearMainDesignComponent mainData = { mainData }
					...
					: currentPageType == 'Page1Component' ? <NewYearPage1DesignComponent detailData = { detailData }
					...
					: currentPageType == 'Page2Component' ? <NewYearPage2DesignComponent detailData = { detailData }
																						   onRemove = {this.onRemove}
																						   onRender={this.onRender}
																						   onPrev = {this.onPrev}
																						   onNext = {this.onNext}
					...
					: currentPageType == 'Page4Component' ? <NewYearPage3DesignComponent detailData = { detailData }
																						   onRemove = {this.onRemove}
																						   onRender={this.onRender}
																						   onPrev = {this.onPrev}
																						   onNext = {this.onNext}
					...
					: currentPageType == 'Page5Component' ? <NewYearPage4DesignComponent detailData = { detailData }
																						   onRemove = {this.onRemove}
																						   onRender={this.onRender}
																						   onPrev = {this.onPrev}
																						   onNext = {this.onNext}
					...
					: currentPageType == 'Page6Component' ? <NewYearPage5DesignComponent detailData = { detailData }
																						   onRemove = {this.onRemove}
																						   onRender={this.onRender}
																						   onPrev = {this.onPrev}
																						   onNext = {this.onNext}
...
export default NewYearDesignComponent;
