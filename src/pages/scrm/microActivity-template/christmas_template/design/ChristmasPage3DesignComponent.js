...
let ChristmasPage3DesignComponent = Form.create()(React.createClass({
	getInitialState() {
		return {
		...
		return (
			...
			<div className="templet-instance-form-content">
				<Form horizontal style={{width:'100%'}}>
					...
					<FormItem {...formItemLayout} label = "副标题" help = '副标题, 不能超过12字' >
...
export default ChristmasPage3DesignComponent;
