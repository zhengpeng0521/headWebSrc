...
//引入页面模板
let ChristmasMainDesignComponent = require('./ChristmasMainDesignComponent');
let ChristmasPage1DesignComponent = require('./ChristmasPage1DesignComponent');
let ChristmasPage2DesignComponent = require('./ChristmasPage2DesignComponent');
let ChristmasPage3DesignComponent = require('./ChristmasPage3DesignComponent');
let ChristmasPage4DesignComponent = require('./ChristmasPage4DesignComponent');
let ChristmasPage5DesignComponent = require('./ChristmasPage5DesignComponent');
let ChristmasPage6DesignComponent = require('./ChristmasPage6DesignComponent');


let ChristmasDesignComponent = React.createClass({
	getInitialState() {
		return {
	...
	render(){
		...
		return (
			...
			<div>
				{
					currentPageType == '' ? < ChristmasMainDesignComponent mainData = { mainData }
					...
					: currentPageType == 'Page1Component' ? <ChristmasPage1DesignComponent detailData = { detailData }
					...
					: currentPageType == 'Page2Component' ? <ChristmasPage2DesignComponent detailData = { detailData }
																						   onRemove = {this.onRemove}
																						   onRender={this.onRender}
																						   onPrev = {this.onPrev}
																						   onNext = {this.onNext}
					...
					: currentPageType == 'Page3Component' ? <ChristmasPage3DesignComponent detailData = { detailData }
																						   onRemove = {this.onRemove}
																						   onRender={this.onRender}
																						   onPrev = {this.onPrev}
																						   onNext = {this.onNext}
					...
					: currentPageType == 'Page4Component' ? <ChristmasPage4DesignComponent detailData = { detailData }
																						   onRemove = {this.onRemove}
																						   onRender={this.onRender}
																						   onPrev = {this.onPrev}
																						   onNext = {this.onNext}
					...
					: currentPageType == 'Page5Component' ? <ChristmasPage5DesignComponent detailData = { detailData }
																						   onRemove = {this.onRemove}
																						   onRender={this.onRender}
																						   onPrev = {this.onPrev}
																						   onNext = {this.onNext}
					...
					: currentPageType == 'Page6Component' ? <ChristmasPage6DesignComponent detailData = { detailData }
																						   onRemove = {this.onRemove}
																						   onRender={this.onRender}
																						   onPrev = {this.onPrev}
																						   onNext = {this.onNext}
...
export default ChristmasDesignComponent	;
