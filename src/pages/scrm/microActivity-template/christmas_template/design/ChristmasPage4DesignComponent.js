...
let ChristmasPage4DesignComponent = Form.create()(React.createClass({
	getInitialState() {
		return {
	...
	imgHandleChange(info){
		...
		form.setFieldsValue({ "shareImage4" : "" });
			...
			<div className="templet-instance-form-content">
				<Form horizontal style={{width:'100%'}}>
					...
					<FormItem>
						...
						<Input placeholder="第四张图片URL" type= "hidden" {...getFieldProps('shareImage4')}/>
					</FormItem>
					...
					<FormItem {...formItemLayout}
							  label="图片"
							  help="最多上传4张图, 图片大小 ≤ 1M, 支持png,jpeg,gif格式">
...
export default ChristmasPage4DesignComponent;
