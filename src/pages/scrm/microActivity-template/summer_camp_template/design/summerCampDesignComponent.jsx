...
//引入页面模板
import SummerCampMainDesignComponent from '../../general_template/generalMainDesignComponent';
import SummerCampPageComponent from './summerCampPageDesignComponent';


let SummerCampDesignComponent = React.createClass({
	getInitialState() {
		return {
	...
	render(){
		...
		return (
			...
			<div>
				{
					currentPageType == '' ? < SummerCampMainDesignComponent   mainData = { mainData }
					...
					: currentPageType == 'Page1Component' ? <SummerCampPageComponent   detailData = { detailData }
...
export default SummerCampDesignComponent;
