...
//引入页面模板
let DoanngoMainDesignComponent = require('../../general_template/generalMainDesignComponent');
let DoanngoPage1DesignComponent = require('../../general_template/Page1DesignComponent3');
let DoanngoPage2DesignComponent = require('../../general_template/Page2DesignComponent');
let DoanngoPage3DesignComponent = require('../../general_template/Page4DesignComponent');
let DoanngoPage4DesignComponent = require('../../general_template/Page5DesignComponent');
let DoanngoPage5DesignComponent = require('../../general_template/Page6DesignComponent');


let DoanngoDesignComponent = React.createClass({
	getInitialState() {
		return {
	...
	render(){
		...
		return (
			...
			<div>
				{
					currentPageType == '' ? < DoanngoMainDesignComponent mainData = { mainData }
					...
					: currentPageType == 'Page1Component' ? <DoanngoPage1DesignComponent detailData = { detailData }
					...
					: currentPageType == 'Page2Component' ? <DoanngoPage2DesignComponent detailData = { detailData }
																						   onRemove = {this.onRemove}
																						   onRender={this.onRender}
																						   onPrev = {this.onPrev}
																						   onNext = {this.onNext}
					...
					: currentPageType == 'Page4Component' ? <DoanngoPage3DesignComponent detailData = { detailData }
																						   onRemove = {this.onRemove}
																						   onRender={this.onRender}
																						   onPrev = {this.onPrev}
																						   onNext = {this.onNext}
					...
					: currentPageType == 'Page5Component' ? <DoanngoPage4DesignComponent detailData = { detailData }
																						   onRemove = {this.onRemove}
																						   onRender={this.onRender}
																						   onPrev = {this.onPrev}
																						   onNext = {this.onNext}
					...
					: currentPageType == 'Page6Component' ? <DoanngoPage5DesignComponent detailData = { detailData }
																						   onRemove = {this.onRemove}
																						   onRender={this.onRender}
																						   onPrev = {this.onPrev}
																						   onNext = {this.onNext}
...
export default DoanngoDesignComponent;
