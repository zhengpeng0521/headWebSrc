...
//引入页面模板
let FathersDayMainDesignComponent  = require('../../general_template/generalMainDesignComponent');
let FathersDayPage1DesignComponent = require('../../general_template/Page1DesignComponent4');
let FathersDayPage2DesignComponent = require('../../general_template/Page2DesignComponent2');
let FathersDayPage3DesignComponent = require('../../general_template/Page4DesignComponent');
let FathersDayPage4DesignComponent = require('../../general_template/Page5DesignComponent');
let FathersDayPage5DesignComponent = require('../../general_template/Page6DesignComponent');


let FathersDayDesignComponent = React.createClass({
	getInitialState() {
		return {
	...
	render(){
		...
		return (
			...
			<div>
				{
					currentPageType == '' ? <FathersDayMainDesignComponent mainData = { mainData }
					...
					: currentPageType == 'Page1Component' ? <FathersDayPage1DesignComponent detailData = { detailData }
					...
					: currentPageType == 'Page2Component' ? <FathersDayPage2DesignComponent detailData = { detailData }
																						   onRemove = {this.onRemove}
																						   onRender={this.onRender}
																						   onPrev = {this.onPrev}
																						   onNext = {this.onNext}
					...
					: currentPageType == 'Page4Component' ? <FathersDayPage3DesignComponent detailData = { detailData }
																						   onRemove = {this.onRemove}
																						   onRender={this.onRender}
																						   onPrev = {this.onPrev}
																						   onNext = {this.onNext}
					...
					: currentPageType == 'Page5Component' ? <FathersDayPage4DesignComponent detailData = { detailData }
																						   onRemove = {this.onRemove}
																						   onRender={this.onRender}
																						   onPrev = {this.onPrev}
																						   onNext = {this.onNext}
					...
					: currentPageType == 'Page6Component' ? <FathersDayPage5DesignComponent detailData = { detailData }
																						   onRemove = {this.onRemove}
																						   onRender={this.onRender}
																						   onPrev = {this.onPrev}
																						   onNext = {this.onNext}
...
export default FathersDayDesignComponent;
