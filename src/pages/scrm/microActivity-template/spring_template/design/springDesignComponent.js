...
//引入页面模板
let SpringMainDesignComponent = require('../../general_template/generalMainDesignComponent');
let SpringPage1DesignComponent = require('../../general_template/Page1DesignComponent');
let SpringPage2DesignComponent = require('../../general_template/Page2DesignComponent');
let SpringPage3DesignComponent = require('../../general_template/Page4DesignComponent');
let SpringPage4DesignComponent = require('../../general_template/Page5DesignComponent');
let SpringPage5DesignComponent = require('../../general_template/Page6DesignComponent');


let SpringDesignComponent = React.createClass({
	getInitialState() {
		return {
	...
	render(){
		...
		return (
			...
			<div>
				{
					currentPageType == '' ? < SpringMainDesignComponent mainData = { mainData }
					...
					: currentPageType == 'Page1Component' ? <SpringPage1DesignComponent detailData = { detailData }
					...
					: currentPageType == 'Page2Component' ? <SpringPage2DesignComponent detailData = { detailData }
																						   onRemove = {this.onRemove}
																						   onRender={this.onRender}
																						   onPrev = {this.onPrev}
																						   onNext = {this.onNext}
					...
					: currentPageType == 'Page4Component' ? <SpringPage3DesignComponent detailData = { detailData }
																						   onRemove = {this.onRemove}
																						   onRender={this.onRender}
																						   onPrev = {this.onPrev}
																						   onNext = {this.onNext}
					...
					: currentPageType == 'Page5Component' ? <SpringPage4DesignComponent detailData = { detailData }
																						   onRemove = {this.onRemove}
																						   onRender={this.onRender}
																						   onPrev = {this.onPrev}
																						   onNext = {this.onNext}
					...
					: currentPageType == 'Page6Component' ? <SpringPage5DesignComponent detailData = { detailData }
																						   onRemove = {this.onRemove}
																						   onRender={this.onRender}
																						   onPrev = {this.onPrev}
																						   onNext = {this.onNext}
...
export default SpringDesignComponent;
