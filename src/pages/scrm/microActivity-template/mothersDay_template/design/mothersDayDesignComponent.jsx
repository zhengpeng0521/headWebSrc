...
//引入页面模板
let MothersDayMainDesignComponent  = require('../../general_template/generalMainDesignComponent');
let MothersDayPage1DesignComponent = require('../../general_template/Page1DesignComponent1');
let MothersDayPage2DesignComponent = require('../../general_template/Page2DesignComponent2');
let MothersDayPage3DesignComponent = require('../../general_template/Page4DesignComponent');
let MothersDayPage4DesignComponent = require('../../general_template/Page5DesignComponent');
let MothersDayPage5DesignComponent = require('../../general_template/Page6DesignComponent');


let MothersDayDesignComponent = React.createClass({
	getInitialState() {
		return {
	...
	render(){
		...
		return (
			...
			<div>
				{
					currentPageType == '' ? <MothersDayMainDesignComponent mainData = { mainData }
					...
					: currentPageType == 'Page1Component' ? <MothersDayPage1DesignComponent detailData = { detailData }
					...
					: currentPageType == 'Page2Component' ? <MothersDayPage2DesignComponent detailData = { detailData }
																						   onRemove = {this.onRemove}
																						   onRender={this.onRender}
																						   onPrev = {this.onPrev}
																						   onNext = {this.onNext}
					...
					: currentPageType == 'Page4Component' ? <MothersDayPage3DesignComponent detailData = { detailData }
																						   onRemove = {this.onRemove}
																						   onRender={this.onRender}
																						   onPrev = {this.onPrev}
																						   onNext = {this.onNext}
					...
					: currentPageType == 'Page5Component' ? <MothersDayPage4DesignComponent detailData = { detailData }
																						   onRemove = {this.onRemove}
																						   onRender={this.onRender}
																						   onPrev = {this.onPrev}
																						   onNext = {this.onNext}
					...
					: currentPageType == 'Page6Component' ? <MothersDayPage5DesignComponent detailData = { detailData }
																						   onRemove = {this.onRemove}
																						   onRender={this.onRender}
																						   onPrev = {this.onPrev}
																						   onNext = {this.onNext}
...
export default MothersDayDesignComponent;
