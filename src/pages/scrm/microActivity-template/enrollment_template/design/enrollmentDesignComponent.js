...
//引入页面模板
let EnrollmentMainDesignComponent = require('../../general_template/generalMainDesignComponent');
let EnrollmentPage1DesignComponent = require('../../general_template/Page1DesignComponent');
let EnrollmentPage2DesignComponent = require('../../general_template/Page2DesignComponent');
let EnrollmentPage3DesignComponent = require('../../general_template/Page4DesignComponent');
let EnrollmentPage4DesignComponent = require('../../general_template/Page5DesignComponent');
let EnrollmentPage5DesignComponent = require('../../general_template/Page6DesignComponent');


let EnrollmentDesignComponent = React.createClass({
	getInitialState() {
		return {
	...
	render(){
		...
		return (
			...
			<div>
				{
					currentPageType == '' ? < EnrollmentMainDesignComponent mainData = { mainData }
					...
					: currentPageType == 'Page1Component' ? <EnrollmentPage1DesignComponent detailData = { detailData }
					...
					: currentPageType == 'Page2Component' ? <EnrollmentPage2DesignComponent detailData = { detailData }
																						   onRemove = {this.onRemove}
																						   onRender={this.onRender}
																						   onPrev = {this.onPrev}
																						   onNext = {this.onNext}
					...
					: currentPageType == 'Page4Component' ? <EnrollmentPage3DesignComponent detailData = { detailData }
																						   onRemove = {this.onRemove}
																						   onRender={this.onRender}
																						   onPrev = {this.onPrev}
																						   onNext = {this.onNext}
					...
					: currentPageType == 'Page5Component' ? <EnrollmentPage4DesignComponent detailData = { detailData }
																						   onRemove = {this.onRemove}
																						   onRender={this.onRender}
																						   onPrev = {this.onPrev}
																						   onNext = {this.onNext}
					...
					: currentPageType == 'Page6Component' ? <EnrollmentPage5DesignComponent detailData = { detailData }
																						   onRemove = {this.onRemove}
																						   onRender={this.onRender}
																						   onPrev = {this.onPrev}
																						   onNext = {this.onNext}
...
export default EnrollmentDesignComponent;
