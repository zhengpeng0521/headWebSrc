...
let ChildrenDayPage1DesignComponent = require('../../general_template/Page1DesignComponent5');
let ChildrenDayPage2DesignComponent = require('../../general_template/Page2DesignComponent4');
let ChildrenDayPage3DesignComponent = require('../../../microLeaflet-template/general_template/page3DesignComponent/page3DesignComponent2');
let ChildrenDayPage4DesignComponent = require('../../general_template/Page4DesignComponent4');
let ChildrenDayPage5DesignComponent = require('../../general_template/Page5DesignComponent2');
let ChildrenDayPage6DesignComponent = require('../../general_template/Page6DesignComponent3');
let ChildrenDayPage7DesignComponent = require('../../general_template/Page7DesignComponent1');
let ChildrenDayPage8DesignComponent = require('../../general_template/Page8DesignComponent');
			...
			<div>
				{
					...
					: currentPageType == 'Page3Component' ? <ChildrenDayPage3DesignComponent detailData = { detailData }
																						   onRemove = {this.onRemove}
																						   onRender={this.onRender}
																						   onPrev = {this.onPrev}
																						   onNext = {this.onNext}
					...
					: currentPageType == 'Page4Component' ? <ChildrenDayPage4DesignComponent detailData = { detailData }
																						   onRemove = {this.onRemove}
																						   onRender={this.onRender}
																						   onPrev = {this.onPrev}
																						   onNext = {this.onNext}
					...
					: currentPageType == 'Page5Component' ? <ChildrenDayPage5DesignComponent detailData = { detailData }
																						   onRemove = {this.onRemove}
																						   onRender={this.onRender}
																						   onPrev = {this.onPrev}
																						   onNext = {this.onNext}
					...
					: currentPageType == 'Page6Component' ? <ChildrenDayPage6DesignComponent detailData = { detailData }
																						   onRemove = {this.onRemove}
																						   onRender={this.onRender}
																						   onPrev = {this.onPrev}
																						   onNext = {this.onNext}
					...
					: currentPageType == 'Page7Component' ? <ChildrenDayPage7DesignComponent detailData = { detailData }
																						   onRemove = {this.onRemove}
																						   onRender={this.onRender}
																						   onPrev = {this.onPrev}
																						   onNext = {this.onNext}
					...
					: currentPageType == 'Page8Component' ? <ChildrenDayPage8DesignComponent detailData = { detailData }
																						   onRemove = {this.onRemove}
																						   onRender={this.onRender}
																						   onPrev = {this.onPrev}
																						   onNext = {this.onNext}
