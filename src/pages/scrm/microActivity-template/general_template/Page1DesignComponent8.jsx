		...
		return (
			...
			<div className="templet-instance-form-content">
				<Form horizontal style={{width:'100%'}}>
					...
					<FormItem {...formItemLayout} label="机构名称" help = '机构名称, 不能超过12字' >
						<Input size = 'default' placeholder="请输入标题" { ...orgNameProps }/>
					</FormItem>
					<FormItem {...formItemLayout} label="标题"  help = '标题, 不能超过24字'>
