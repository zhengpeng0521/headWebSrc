...
let MusicPage4DesignComponent = Form.create()(React.createClass({
	getInitialState() {
		return {
	...
	initFormData( detailData ){
		...
		form.setFieldsValue({ "page4Content"  : detailData.content });
	...
	render () {
		...
		//内容属性
		let contentProps = getFieldProps('page4Content',{
			validate : [{
				rules : [
...
export default MusicPage4DesignComponent;
