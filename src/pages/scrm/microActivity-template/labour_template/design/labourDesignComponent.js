...
//引入页面模板
let LabourMainDesignComponent = require('../../general_template/generalMainDesignComponent');
let LabourPage1DesignComponent = require('../../general_template/Page1DesignComponent1');
let LabourPage2DesignComponent = require('../../general_template/Page2DesignComponent');
let LabourPage3DesignComponent = require('../../general_template/Page3DesignComponent1');
let LabourPage4DesignComponent = require('../../general_template/Page4DesignComponent1');
let LabourPage5DesignComponent = require('../../general_template/Page5DesignComponent');
let LabourPage6DesignComponent = require('../../general_template/Page6DesignComponent');


let LabourDesignComponent = React.createClass({
	getInitialState() {
		return {
	...
	render(){
		...
		return (
			...
			<div>
				{
					currentPageType == '' ? < LabourMainDesignComponent mainData = { mainData }
					...
					: currentPageType == 'Page1Component' ? <LabourPage1DesignComponent detailData = { detailData }
					...
					: currentPageType == 'Page2Component' ? <LabourPage2DesignComponent detailData = { detailData }
																						   onRemove = {this.onRemove}
																						   onRender={this.onRender}
																						   onPrev = {this.onPrev}
																						   onNext = {this.onNext}
					...
					: currentPageType == 'Page3Component' ? <LabourPage3DesignComponent detailData = { detailData }
																						   onRemove = {this.onRemove}
																						   onRender={this.onRender}
																						   onPrev = {this.onPrev}
																						   onNext = {this.onNext}
					...
					: currentPageType == 'Page4Component' ? <LabourPage4DesignComponent detailData = { detailData }
																						   onRemove = {this.onRemove}
																						   onRender={this.onRender}
																						   onPrev = {this.onPrev}
																						   onNext = {this.onNext}
					...
					: currentPageType == 'Page5Component' ? <LabourPage5DesignComponent detailData = { detailData }
																						   onRemove = {this.onRemove}
																						   onRender={this.onRender}
																						   onPrev = {this.onPrev}
																						   onNext = {this.onNext}
					...
					: currentPageType == 'Page6Component' ? <LabourPage6DesignComponent detailData = { detailData }
																						   onRemove = {this.onRemove}
																						   onRender={this.onRender}
																						   onPrev = {this.onPrev}
																						   onNext = {this.onNext}
...
export default LabourDesignComponent;
