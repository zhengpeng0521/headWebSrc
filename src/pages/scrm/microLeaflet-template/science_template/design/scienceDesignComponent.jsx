...
//引入页面 配置模板
let ScienceMainDesignComponent = require('../../general_template/generalMainDesignComponent');
let SciencePageDesignComponent = require('./sciencePageDesignComponent');
...
let ScienceDesignComponent = React.createClass({
	...
	render(){
		...
		return (
			...
			<div>
				{
					currentPageType == '' ? < ScienceMainDesignComponent  mainData = { mainData }
					...
					: currentPageType == 'Page1Component' ? <SciencePageDesignComponent    detailData = { detailData }
