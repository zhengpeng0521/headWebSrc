...
//引入页面 配置模板
let FineArtsMainDesignComponent = require('../../general_template/generalMainDesignComponent');
let FineArtsPageDesignComponent = require('./fineArtsPageDesignComponent');

let ScienceDesignComponent = React.createClass({
	getInitialState() {
		return {
	...
	render(){
		...
		return (
			...
			<div>
				{
					currentPageType == '' ? < FineArtsMainDesignComponent  mainData = { mainData }
					...
					: currentPageType == 'Page1Component' ? <FineArtsPageDesignComponent    detailData = { detailData }
...
export default ScienceDesignComponent;
