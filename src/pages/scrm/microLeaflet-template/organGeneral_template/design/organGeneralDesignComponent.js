...
//引入页面 配置模板
let OrganGeneralMainDesignComponent = require('../../general_template/generalMainDesignComponent');
let OrganGeneralPage1DesignComponent = require('../../general_template/page1DesignComponent/page1DesignComponent1');
let OrganGeneralPage2DesignComponent = require('../../general_template/page2DesignComponent/page2DesignComponent');
let OrganGeneralPage3DesignComponent = require('../../general_template/page3DesignComponent/page3DesignComponent');

let OrganGeneralDesignComponent = React.createClass({
	getInitialState() {
		return {
	...
	render(){
		...
		return (
			...
			<div>
				{
					currentPageType == '' ? < OrganGeneralMainDesignComponent mainData = { mainData }
					...
					: currentPageType == 'Page1Component' ? <OrganGeneralPage1DesignComponent   detailData = { detailData }
					...
					: currentPageType == 'Page2Component' ? <OrganGeneralPage2DesignComponent   detailData = { detailData }
																						   onRemove = {this.onRemove}
																						   onRender={this.onRender}
																						   onPrev = {this.onPrev}
																						   onNext = {this.onNext}
					...
					: currentPageType == 'Page3Component' ? <OrganGeneralPage3DesignComponent   detailData = { detailData }
																						   onRemove = {this.onRemove}
																						   onRender={this.onRender}
																						   onPrev = {this.onPrev}
																						   onNext = {this.onNext}
...
export default OrganGeneralDesignComponent;
