...
//引入页面 配置模板
let OrganCommonMainDesignComponent = require('../../general_template/generalMainDesignComponent');
let OrganCommonPageDesignComponent = require('./organCommonPageDesignComponent');

let OrganCommonDesignComponent = React.createClass({
	getInitialState() {
		return {
	...
	render(){
		...
		return (
			...
			<div>
				{
					currentPageType == '' ? < OrganCommonMainDesignComponent mainData = { mainData }
					...
					: currentPageType == 'Page1Component' ? <OrganCommonPageDesignComponent   detailData = { detailData }
...
export default OrganCommonDesignComponent;
