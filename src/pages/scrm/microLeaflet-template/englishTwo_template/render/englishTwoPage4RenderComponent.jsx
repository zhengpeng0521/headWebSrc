...
let EnglishTwoPage4RenderComponent = React.createClass({
	getInitialState() {
		return {
	...
	render(){
		...
		return (
			<div className = 'page-render-design english_two_page4_render english_two_answer' >
...
export default EnglishTwoPage4RenderComponent;
