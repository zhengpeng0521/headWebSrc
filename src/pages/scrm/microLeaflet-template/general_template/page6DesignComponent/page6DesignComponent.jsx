...
let EnglishTwoPage6DesignComponent = Form.create()(React.createClass({
	getInitialState() {
		return {
	...
	render () {
		...
		//内容属性
		let contentProps = getFieldProps('page6Content',{
			validate : [{
				rules : [
			...
			<div className="templet-instance-form-content">
				<Form horizontal style = {{ width:'100%' }} >
					...
					<FormItem
						...
						help = '内容, 不超过50字'
					>
						<Input size = 'default' placeholder = "请输入内容, 不超过50字" { ...contentProps } />
					</FormItem>
...
export default EnglishTwoPage6DesignComponent;
