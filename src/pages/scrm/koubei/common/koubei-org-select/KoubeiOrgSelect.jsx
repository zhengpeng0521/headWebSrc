...
const KoubeiOrgSelect = React.createClass({
    getInitialState() {
        return {
            loading: false,             //是否加载中
    ...
    init() {
        let me = this;
        serviceRequest(`${BASE_URL}/orderOrgController/shopList`, {commodityId: this.props.commodityId || '201610200194070711'},
            function(ret) {
...
export default KoubeiOrgSelect;
