...
let KoubeiActivitySearch = React.createClass({
	getInitialState() {
		return {
				...
				<Form horizontal className="ant-advanced-search-form" >
	    			<div className="search-content">
	    				<div className="search-item">
							<Input placeholder="请输入活动编号" {...getFieldProps('id')} />
						</div>
						<div className="search-item">
...
let KoubeiActivitySearch_T = Form.create()(KoubeiActivitySearch);

export default React.createClass({
	render() {
		return (
             <KoubeiActivitySearch_T onSearch={this.props.onSearch} />
		);
	}
});
