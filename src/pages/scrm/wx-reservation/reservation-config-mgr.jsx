...
let ReservationConfig = React.createClass({
	...
	initReservationConfig() {
		let me = this;
		  serviceRequest(BASE_URL+'reservationConfig/get', {funcKey: 'reservationconfigmgr-get'},
			  function(ret) {
			  	let config = ret.data.config || {};
				me.setState({
	...
	updateReservationConfig() {
		...
		serviceRequest(BASE_URL+'reservationConfig/save',
				{
					funcKey: 'reservationconfigmgr-save',
		...
		return (
			<div className="page-content">
				<div className="config-page">
					...
					<Card title="预约显示项设置" style={{ width: '100%' }}>
