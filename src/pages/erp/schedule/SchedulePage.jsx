...
import ScheduleOperationComponent from '../../../components/erp/schedule/ScheduleOperation';
import ScheduleDateComponent from '../../../components/erp/schedule/ScheduleDateComponent';
import ScheduleTeachComponent from '../../../components/erp/schedule/ScheduleTeachComponent';
import ScheduleRoomComponent from '../../../components/erp/schedule/ScheduleRoomComponent';

import ClassScheduleFormPage from '../class-schedule/ClassScheduleFormPage';
...
//		let orgId = window._init_data.firstOrg.key;                     //??????????到底用哪个orgId
	...
	init( startDay, endDay, orgId ){
		...
		//初始化教室下拉框
		serviceRequest(`${BASE_URL}/classRoomController/summaryQuery`, { orgId },
			function(ret) {
				me.setState({
	...
	querySchedule( startDay, endDay, orgId ){
        ...
        serviceRequest(`${BASE_URL}/coursePlanController/cpquery`, { startDay, endDay, orgId },
            function( ret ) {
                let state = me.state;
				me.setState({
	...
	render(){
		...
		return (
			<div style = {{ height : '100%' }} >
				...
				<ClassScheduleFormPage { ...scheduleFormPageProps } />
			</div>
		)
	}
}
