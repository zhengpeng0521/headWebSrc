...
import stylesNormal from './PageModal.less';
import stylesTms from './PageModalTms.less';
//是否是番茄田系统
        ...
        <div className={visible ? 'form_modal_box form_modal_box_open' : 'form_modal_box form_modal_box_close'} id='common_form_modal_box'>
          ...
          <div className={visible ? 'form_modal_page form_modal_page_active' : 'form_modal_page'} style={{ width : width || 600 }}>
              <div className={styles.form_modal_header}>
               ...
               <div className={styles.form_modal_content} id='common_form_modal_content' style={ footer ? { width : '100%', height : 'calc(100% - 40px)'} : { width : '100%', height : 'calc(100% - 30px)'}}>
...
//            e.stopPropagation();
    ...
    render() {
        return (
            <Icon style={{display: 'none'}} type={this.state.iconType} onClick={this.handleOnClose} onMouseOver={this.onHover} onMouseOut={this.onMouseOut}/>
        );
    }
}
