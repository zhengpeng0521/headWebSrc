...
class TreeSelectOrgDept extends React.Component{
    ...
    componentDidMount(){
        ...
        if(this.props.isHq == 1){
            ...
            serviceRequest1(`${BASE_URL}/crm/hq/org/orgDeptTreeQuery`, {},
                function(ret) {
                    me.setState({ listContent : ret.results })
                }
            );
            ...
            <Media query="(max-width: 1350px)">
                { matches => matches ?
                    (<TreeSelect
                        ...
                        style = {{ width: this.props.s_width || 200 }}
                    ...
                    (<TreeSelect
                        showSearch
                        treeDefaultExpandAll
                        style = {{ width: this.props.l_width || 300 }}
                        dropdownStyle = {{ maxHeight: 400, overflow: 'auto' }}
                        value = { orgDept || this.props.value || undefined }
                        placeholder = "请选择校区"
                        allowClear = { this.props.allowClear || allow_clear }
                        ...
                        multiple={multiple}
                        treeCheckable={multiple}
                        className={styles.common_mgr_search_org_filter}
                      >
                          <TreeNode value = "all_orgDept" title = "所有校区" key = "all_orgDept" disabled>
                              { renderListContent }
                          </TreeNode>
