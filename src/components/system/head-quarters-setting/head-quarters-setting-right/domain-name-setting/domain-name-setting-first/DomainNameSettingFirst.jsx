...
function DomainNameSettingFirst({
    ...
    return(
        <div className={styles.all}>
            ...
            <Button type = 'primary' style = {{ width : 110 }} onClick = { submit } disabled = { domainFirstStepSubmitButtonLoading || !getFieldValue('agree') } loading = { domainFirstStepSubmitButtonLoading }>申请使用</Button>
        </div>
    );
}
