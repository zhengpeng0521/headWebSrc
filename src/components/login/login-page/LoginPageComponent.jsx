    ...
    return (
        <div className={styles.login_page_content} >
            <div className={styles.login_page_bg}
                style={{
                    background: 'url(https://img.ishanshan.com/gimg/img/2354ebeece1f829e718369c1026162cf) no-repeat', backgroundSize: 'cover'
                }}
            ></div>
            ...
            <div className={styles.foot_content}>
                ...
                <div className={styles.foot_text}>联系方式： 0571-56000069</div>
                <div className={styles.foot_text}>联系地址： 杭州市滨江区海威大厦18F</div>
            </div>
            <LoginTenantSelect loading={loading} visible={tenantSeelctVisible} tenantList={tenantList} tenantSelect={tenantSelect} />
            <AccountActivePage />
        </div>
    );
}
                    ...
                    <Element key="account_login" hideProps>
                        <QueueAnim type="bottom" duration={500} delay={[500, 0]} key="account_login_cont">
                          <div key="logo_and_logintype" className={styles.logo_and_logintype}>
                              <div className={styles.login_handel_logo}>
                                  <img src={this.state.logoImgUrl} />
                              </div>
...
/*登陆时  多租户选择界面*/
function LoginTenantSelect ({loading,visible,tenantList,tenantSelect,}) {
