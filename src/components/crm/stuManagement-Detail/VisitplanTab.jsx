...
import { StatusFlag , NullData } from '../../../components/common/new-component/NewComponent';
import styles from './VisitplanTab.less';
...
function VisitingPlan({
            ...
            return(
                <div className={styles.visiting_plan_list_item} key = { index }>
                    ...
                    <div className={styles.visiting_plan_list_item_content}>
                        ...
                        {/*<span onClick = {() => LeadsFollowVisitingPlanAddOrEditItem('edit',item)}>编辑</span>*/}
    ...
    let allHeight = 70 + IntroHeight + 47 + 20 + 28 + 10;     //最上面菜单的高度+信息的高度+tab的高度+外层内边距+按钮高度+按钮下外边距
    ...
    return(
        <div className={styles.stumanage_visiting_plan_inner_list} onScroll={ isScrollToBottom } >
            ...
            <Spin spinning = { leadsFollowVisitingPlanContentLoading }>
                <div className={styles.leads_visiting_plan_inner_list} id='stumanage_visiting_plan_inner_list' style={{height:`calc(100vh - ${allHeight}px)`}}>
                    { visitingPlan || [] }
