...
import { Modal, Button, Steps, Tabs } from "antd"
...
import styles from "./ExpenseImport.less"
  ...
  if (contractOrderImportModalStep == "0") {
    ...
    footer = [
      <Button
        key="cancel"
        type="ghost"
        onClick={() => ModalOperation("second_prestep")}>
        上一步
      </Button>,
      <Button
        key="submit"
    ...
    footer = [
      <Button
        key="cancel"
        type="ghost"
        onClick={() => ModalOperation("last_prestep")}
        style={{ display: thirdLastButtonDisplay }}>
        上一步
      </Button>,
      <Button
        key="submit"
  ...
  return (
    <Modal {...modalOpts}>
      <div className={styles.steps}>
        ...
        <Tabs
          defaultActiveKey="0"
          activeKey={contractOrderImportModalStep + ""}
          size="small">
          <TabPane tab="" key="0">
