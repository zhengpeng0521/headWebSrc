        ...
        <Form className={styles.Form}>
                ...
                <div className={styles.SearchItem}>
                    <span style={{lineHeight:'28px',marginLeft:'20px'}}>统计校区:
                        <strong style={{color:'#5d9cec'}}>
                            {topOrgCount == '' || topOrgCount == null || topOrgCount == undefined ?
                                '无'
                                :
                                `${topOrgCount}家`
                            }
            ...
            <div className={styles.SearchBottom}>
                ...
                <span style={{color:'#e23636'}}>
                    {topAllInCome && topAllInCome != undefined && topAllInCome != '' && topAllInCome != null && topAllInCome.money && topAllInCome.money != '' && topAllInCome.money != null && topAllInCome.money != undefined ?
                        `￥${topAllInCome.money}`
                        :
                        '无'
                    }
