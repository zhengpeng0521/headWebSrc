...
import { scheduleDataByDate, scheduleDataByTeach, scheduleDataByTime } from '../../../utils/scheduleUtils';
...
function ScheduleTeachComponent({
	...
	let scheduleDataListByTeach = scheduleDataByTeach( scheduleDataListByDate, selectedTeachers );   //按老師整理
